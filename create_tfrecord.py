...
flags.DEFINE_string('dataset_dir', '/home/ailab/Workspace/Data/cub_test/', 'String: Your dataset directory')

# The number of images in the validation set. You would have to know the total number of examples in advance. This is essentially your evaluation dataset.
flags.DEFINE_float('validation_size', 1.0, 'Float: The proportion of examples in the dataset to be used for validation')
...
flags.DEFINE_string('tfrecord_filename', '/home/ailab/Workspace/Data/cub_test/', 'String: The output filename to name your TFRecord file')
