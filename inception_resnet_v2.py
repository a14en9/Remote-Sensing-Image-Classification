...
def inception_resnet_v2_base(inputs,
  ...
  def add_and_check_final(name, net):
    return name == final_endpoint # I don't want endpoint, because it costs too much memory!
  ...
  with tf.variable_scope(scope, 'InceptionResnetV2', [inputs]):
    ...
    raise ValueError('final_eend_pointsndpoint (%s) not recognized', final_endpoint)
